...
\title{On the Isometry of $(\mathfrak{M}_+(\Omega), \operatorname{HK})$ and $(\mathfrak{C}_\Omega, W_2)$}
...
\end{equation}
We now solve this system explicitly. By \Cref{cone geodesic equations via covariant deriv}, the quantity $q \triangleq r_t^2 v_t$ is independent of $t$. Set $c \triangleq \|q\|_2$.
